...
class WhenBoatsMeetScreen extends StatefulWidget {
  const WhenBoatsMeetScreen({super.key});

  @override
  State<WhenBoatsMeetScreen> createState() => _WhenBoatsMeetScreenState();
}

class _WhenBoatsMeetScreenState extends State<WhenBoatsMeetScreen> {
  @override
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: ListView.separated(
                ...
                itemCount: partTwoMenuData.length,
