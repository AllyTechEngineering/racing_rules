...
class ProtestAppealsScreen extends StatefulWidget {
  const ProtestAppealsScreen({super.key});

  @override
  State<ProtestAppealsScreen> createState() => _ProtestAppealsScreenState();
}

class _ProtestAppealsScreenState extends State<ProtestAppealsScreen> {
  @override
