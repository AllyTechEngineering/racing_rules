...
class EntryQualScreen extends StatefulWidget {
  const EntryQualScreen({super.key});

  @override
  State<EntryQualScreen> createState() => _EntryQualScreenState();
}

class _EntryQualScreenState extends State<EntryQualScreen> {
  @override
