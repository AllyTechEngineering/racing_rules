...
class RaceSignalsScreen extends StatefulWidget {
  const RaceSignalsScreen({super.key});

  @override
  State<RaceSignalsScreen> createState() => _RaceSignalsScreenState();
}

class _RaceSignalsScreenState extends State<RaceSignalsScreen> {
  @override
